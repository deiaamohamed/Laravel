...
<form action="/posts" method="POST" class="p-8 space-y-4 max-w-md">
    ...
    <label for="name" class="block">
        ...
        <div class="relative">
            <input type="text" id="name" name="name" class="mt-0.5 w-full rounded border-gray-300 pe-10 shadow-sm sm:text-sm">
        </div>
    </label>
    ...
    <label for="post" class="block">
        ...
        <div class="relative">
            <input type="text" id="post" name="post" class="mt-0.5 w-full rounded border-gray-300 pe-10 shadow-sm sm:text-sm">
        </div>
    </label>
